...
namespace MainForm
{
    ...
    public partial class CauHoi_3 : UserControl
    {
       ...
       public string getChoTrong(bool type)
        {
            return (type == true ? " ........... " + "(" + SoDapAn + ") " : " ........... ");
        ...
        {
            SoDapAn++;
            txtCauHoi.Text += getChoTrong(true);
        ...
        private void txtCauHoi_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (temp.Contains(getChoTrong(false).Trim()))
                    DemSoChoTrong++;
            }
